<script setup>
    ...
    const headers = ref([
            ...
            { title: 'Nama Kategori', align: 'start', sortable: false, key: 'nama_kategori'},
                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        >
                            ...
                            <template v-slot:item.aksi="{ item }">
                                <div class="text-end">
                                    <Link :href="route('kategori.edit', {kategori: item.id })" class="text-indigo-400 hover:underline">Detail</Link>
                                </div>
                            </template>
                        </v-data-table>
                    </v-card>
